          ...
          <div class="span12">
			...
			<?php
                                    if(isset($_POST['submit_publish'])){
                                        ...
                                        $insere="INSERT INTO problema (descricao,cod_utilizador,cod_categoria,data_hora) VALUES ('".$descricao."','".$_SESSION['cod_utilizador']."','".$cod_categoria."',now())";
                    ...
                    tamanho_imagem='".$file_size."',dados_imagem='".$data."' where cod_problema='".$cod."'";
            ...
            <form action="" method="POST" role="form" class="contactForm" enctype="multipart/form-data">
              ...
              <div class="row">
				...
				<p>Descrição da Ocorrência</p>
                  <textarea class="form-control" name="descricao" rows="12" data-rule="required" required="required"></textarea>
                  <div class="validation"></div>
                  <p class="text-center">
                    <button class="btn btn-large btn-theme margintop10" name="submit_publish" type="submit">Publicar</button>
                  </p>
                </div>
              </div>
            </form>
