...
//Envio de mensagem para o email do contacto a confirmar a receção dos dados:
    ...
    $mensagem_1->__set('mensagem' , "Obrigado por subscrever a nossa newsletter.
	http://localhost/pap_2021_carlostato/index.php?pagina=validar_newsletter&email=$email;
